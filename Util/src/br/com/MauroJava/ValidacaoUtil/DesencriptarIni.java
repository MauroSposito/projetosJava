...
public class DesencriptarIni {
	...
	public static void main(String[] args) throws Exception{
		...
		if (arquivo.exists()){
			int sair = JOptionPane.showConfirmDialog(null,"Arquivo conf_desencriptado.ini já existe, Subscrever?","Atenção",JOptionPane.YES_NO_OPTION);
			if(sair == JOptionPane.YES_OPTION){
				arquivo.delete();
				
			} else {
				JOptionPane.showMessageDialog(null, "Saindo do sistema sem executar operação");
				System.exit(0);
			}
		}
		arquivo = new File("C:\\Users\\mauro\\Desktop\\conf_desencriptado.ini");
