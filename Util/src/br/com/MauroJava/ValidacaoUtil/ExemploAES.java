...
public class ExemploAES{
	...
	public static void main (String[] args) throws Exception{
		...
		String texto = "Em Criptografia, o Advance Encryption Standard (AES, ou Padrão de Critografia Avançado, em português) também o AES já é um dos algoritmos mais populares usados para criptografia simétrica";
